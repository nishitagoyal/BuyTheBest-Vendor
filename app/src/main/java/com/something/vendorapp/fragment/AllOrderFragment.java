...
import com.something.vendorapp.adapter.AllOrdersPlacedAdapter;
    ...
    private void populateList() {
        orderPlaceRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                orderPlacedRecyclerView.setAdapter(new AllOrdersPlacedAdapter(getContext(), reverseOrderPlacedList,AllOrderFragment.this));
